<?php
class AsbestosView extends WebPageTemplateView
{
        ...
        <body>
            ...
            <div class="training-div">
                ...
                <p id="Guidance">
                    ...
                    Our Asbestos register can be found in R: /hse/section10/asbestos this should be checked before any building or maintenance works are commenced.
                </p>
                <br>
                <h2>Summary:</h2>
                <br>
                ...
                <form method="post" action="">
                    <label for="text"> 1.Where is asbestos commonly found?</label>
                    <br>
                    ...
                    <br><br>
                    <label for="text">2.What should be done before any building or maintenance work takes place on a building?</label>
                    <br>
                    ...
                    <br><br>
                    <button class ="training-button" type="submit" name="route" value="asbestos_answer">Submit</button>
            </div>
        </body>
    </main>
HTMLFORM;
