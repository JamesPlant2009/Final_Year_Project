<?php
class ElectricView extends WebPageTemplateView
{
...
Check for signs of damage to equipment and cables, if in doubt have the circuit/equipment checked by an electrician before starting work. Report concerns to management.
                ...
                <form method="post" action="">
                    <label for="text"> 1.What are the main hazards of working with electricity?</label>
                    <br>
                    ...
                    <br><br>
                    <label for="text">2.What regulations cover working with electricity?</label>
                    <br>
                    ...
                    <br><br>
                    <button class ="training-button" type="submit" name="route" value="electric_answer">Submit</button>
            </div>
        </body>
    </main>
HTMLFORM;
