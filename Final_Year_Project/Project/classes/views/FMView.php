<?php
class FMView extends WebPageTemplateView
{
...
With the above in mind, let's look at the role and responsibilities of our Fire Marshals.
                ...
                <p id="importance">
                 <br><br>
<h3>Fire Marshals must ensure that:</h3>
<br><br>
...
<br><br><br><br>
<h3>Upon hearing the fire alarm:</h3>
<br><br>
...
•	Report the information to the fire officer in charge once they arrive
                ...
                <form method="post" action="">
                    <label for="text"> 1.When is our fire alarm tested?</label>
                    <br>
                    ...
                    <br><br>
                    <label for="text">2.What is the importance of staff and visitors signing in and out?</label>
                    <br>
                    ...
                    <br><br>
                    <button class ="training-button" type="submit" name="route" value="fm_answer">Submit</button>
            </div>
        </body>
    </main>
HTMLFORM;
