...
class TrainingHomeView extends WebPageTemplateView
{
    ...
    <div class="training-home">
        ...
        <button class="training-home-button" type="button" value="button"><a href="#"></a>Control of Contractors & Visitors</button>
        <button class="training-home-button" type="button" value="button"><a href="#"></a>COSHH Awareness</button>
        <button class="training-home-button" type="button" value="button"><a href="#"></a>Dermatitis Awareness</button>
        <button class="training-home-button" type="button" value="button"><a href="#"></a>Electrical Safety Awareness</button>
        <br><br>
        <button class="training-home-button" type="button" value="button"><a href="#"></a>Environmental Awareness</button>
