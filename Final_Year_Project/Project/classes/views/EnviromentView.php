<?php
class EnviromentView extends WebPageTemplateView
{
...
ked before any building or maintenance works are commenced.
                ...
                <form method="post" action="">
                    <label for="text">1.What documentation is required for those who are involved in the collection of waste?</label>
                    <br>
                    ...
                    <br><br>
                    <label for="text">2.What is a key points regarding waste management?</label>
                    <br>
                    ...
                    <br><br>
                    <button class ="training-button" type="submit" name ="route" value="enviroment_answer">Submit</button>
            </div>
        </body>
    </main>
HTMLFORM;
